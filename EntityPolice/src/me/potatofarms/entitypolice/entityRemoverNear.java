...
{
   public String removeEntitiesNear(Player playerC, double x, double y, double z, String entityName, String pluginName)
   {
      Integer all = 0;
      ...
      return ChatColor.GOLD + "[" + pluginName + "]" + ChatColor.GREEN
            + " Es wurden " + ChatColor.WHITE + all.toString() + ChatColor.GREEN + " " + entityName + "s innerhalb von " + x + " Metern um " + playerC.getName() + " entfernt.";
