...
{
   public String removeEntities(Player player, String entityName, String worldName, String pluginName, String[] args)
   {
      Integer total = 0;
      ...
      return ChatColor.GOLD + "[" + pluginName + "]" + ChatColor.GREEN
            + " Es wurden " + ChatColor.WHITE + total.toString() + ChatColor.GREEN + " " + entityName + "s aus allen geladenen Welten entfernt.";
   }
}
